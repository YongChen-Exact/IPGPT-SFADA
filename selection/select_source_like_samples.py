...
parser.add_argument("--target_path", type=str, default="/home/data/CY/Datasets/MMS/Heart_B/training_set", help="Name of Experiment")
parser.add_argument('--source_model', type=str,
                    default='/home/data/CY/codes/IPGPT-SFADA/Model/Heart_A_unet/unet_best_model.pth',
                    help='data_name')
parser.add_argument('--uncertainty', type=str, default='variance', help='entropy or variance')
parser.add_argument('--source_like_samples', type=str, default='/home/data/CY/Datasets/MMS/Heart_B/source_like')
