...
parser.add_argument("--root_path", type=str, default="/home/data/CY/Datasets/Prostate_RUNMC_BMC",
                    help="Path to the source dataset")
parser.add_argument("--source", type=str, default="Prostate_RUNMC_BMC",
                    help="Name of the source domain dataset")
...
if __name__ == "__main__":
    ...
    snapshot_path = "./Model/{}_{}".format(args.source, args.model)
