...
parser.add_argument("--model_path", type=str, default="/home/data/CY/codes/IPGPT-SFADA/Code_OA/Model/Prostate_RUNMC_BMC_unet/unet_best_model.pth")
parser.add_argument("--active_path", type=str, default="/home/data/CY/codes/IPGPT-SFADA/Code_OA/Results/selection_list/Prostate_HCRUDB.txt", help="Source_model_name")
parser.add_argument("--source", type=str, default="RUNMC_BMC", help="Source_model_name")
parser.add_argument("--target", type=str, default="HCRUDB", help="experiment_data name")
...
def train(args, snapshot_path):
    ...
    labeled_dataset = active_DataSets(base_dir=args.root_path, split="train",
                                      transform=RandomGenerator(args.patch_size), active_path=args.active_path)
    ...
    for epoch_num in iterator:
        ...
        for i_batch, (labeled_data, unlabeled_data) in enumerate(zip(labeled_loader, unlabeled_loader)):
            ...
            supervised_loss1 = 0.5 * (ce_loss(outputs, label_batch.long()) + dice_loss(outputs_soft[:, 1, ...], label_batch))
            outputs_emas = []
            ...
            supervised_loss2 = 0.5 * (ce_loss(un_output, pseudo_labels.long()) + dice_loss(un_outputs_soft[:, 1, ...], pseudo_labels))
