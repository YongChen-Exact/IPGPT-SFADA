...
def Deeplab(num_classes=21, pretrained=True, inversion=False, contrast=False, refuge=False, gmm=False):
    model = ResNet(Bottleneck, [3, 4, 23, 3], num_classes, inversion, contrast, refuge, gmm)

    if pretrained:
        restore_from = '/home/cyang/SFDA/checkpoint/resnet_pretrain.pth'
